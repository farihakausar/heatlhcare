...
function Sidebar(props) {
 ...
 const { window } = props;
  ...
  const rows = [
    createData('admin@123', 'admin@123t6','Client admin','action'),
    createData('admin@123', 'admin@123t6','Client admin','action'),
    createData('admin@123', 'admin@123t6','Client admin','action'),
...
<Box
      ...
      >
        <Fragment>
          <Box sx={{display:"flex",flexDirection:"row",justifyContent:"flex-end",marginY:{lg:3}}}>
...
>
          ...
          <TableHead >
            <TableRow>
              <TableCell className='btn'>Name</TableCell>
              
              <TableCell className='btn'>Email</TableCell>
              <TableCell align="center" className='btn'>role &nbsp;</TableCell>
              
              <TableCell align="right" className='btn'>Action&nbsp;</TableCell>
          
            </TableRow>
            
            {/* <Box sx={{borderBottom:"1px solid gray",position: 'absolute',
width: {lg:"55rem"},
height: 0,
}}></Box> */}
          ...
          <TableBody>
            {rows.map(row => (
              <TableRow key={row.name}>
                ...
                <TableCell align="right" className='text'>{row.role}</TableCell>
               
                <TableCell align="right"className="btn-pill m-1 text badge badge-warning">
               

                {rows.action='1'?<>< BorderColorIcon/> <DeleteOutlineIcon/></>:<Button variant="contained"
